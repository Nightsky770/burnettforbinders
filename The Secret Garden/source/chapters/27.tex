...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,4.25cm)$) {\includegraphics[width=1.05\textwidth]{garden}};
	\end{tikzpicture}
...
\begin{letter}
	...
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,2.2cm)$) {\includegraphics[width=.9\textwidth]{garden}};
	\end{tikzpicture}
\end{letter}